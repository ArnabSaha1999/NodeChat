...
const ProfileContent = () => {
  ...
  return (
    <div
      className={`flex justify-center gap-10 flex-col w-[70vw] 2xl:w-[65vw] md:w-[100vw] min-h-[100vh] p-5 md:px-2 min-w-[330px] transition-all duration-300 relative bg-white dark:bg-zinc-950 ${
        isSideBarOpen
